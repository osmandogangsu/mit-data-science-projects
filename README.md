...
Certificate Verification: [verify.mygreatlearning.com/HWOQRXFH](https://verify.mygreatlearning.com/HWOQRXFH)
...
Python Foundations Notebook · [View Project](notebooks_Intro_Osman%20Dogan.html)

Introductory exercises covering Python fundamentals, statistical concepts, and data manipulation techniques that form the foundation for the program's machine learning modules.

Pima Diabetes Analysis · [View Project](Pima_Diabetes_Analysis_Osman%20Dogan.html)
...
Tourism Package Purchase Prediction · [View Notebook](Tourism_Package_Prediction.ipynb)
...
Credit Card Users Churn Prediction · [View Notebook](Credit%20Card%20Users%20Churn%20Prediction.ipynb)
...
Employee Attrition Prediction · [View Notebook](Case_Study_Employee_Attrition.ipynb)
...
Amazon Product Reviews — Recommendation Engine** · [View Notebook](Product_Recommendation_Solution.ipynb)
...
Movie Recommendation System · [View Project](Movie_Recommendation_System.html)
...
| Machine Learning | Scikit-learn (classification, regression, model selection, preprocessing) |
| Recommendation | Surprise, SciPy |
...
- LinkedIn: [linkedin.com/in/osman-doğan-83b50a333](https://www.linkedin.com/in/osman-do%C4%9Fan-83b50a333)
- Email: osmandogangsu@gmail.com

---

These projects were completed as part of the MIT IDSS Data Science and Machine Learning: Making Data-Driven Decisions professional certificate program (April 2023). Datasets were provided for educational purposes within the program and are not redistributed here.*
